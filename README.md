...
- *[Route Mapper](https://github.com/gabrielglbh/Route-Mapper)*: simulation of a route calculation process for taxis with Google Maps Integration. Built with **Android Jetpack Compose** using Hilt/Dagger, Coroutines, DDD, testing... More extensive insights in the README doc.
