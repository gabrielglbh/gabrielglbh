...
- *[Route Mapper](https://github.com/gabrielglbh/Route-Mapper)*: route and price calculation app for car travel with Google Maps Integration. Built with **Android Jetpack Compose** using Hilt/Dagger, Coroutines, DDD, testing... More extensive insights in the README doc.
